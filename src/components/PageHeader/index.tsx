...
export default class PageHeader extends React.Component<PageHeaderProps> {
  ...
  render() {
    const { className, onBack, title, subTitle, extra, ghost, children, breadcrumb, backIcon } =
      this.props
            ...
            {backIcon && (
              <div className='wk-page-header-back' onClick={onBack}>
                <div className='wk-page-header-back-button'>
                  <span className='wkaction-arrow-left'>{backIcon}</span>
                </div>
              </div>
            )}
            <span className='wk-page-header-heading-title'>{title}</span>
            <span className='wk-page-header-heading-sub-title'>{subTitle}</span>
          </div>
          {extra && <div className='wk-page-header-heading-extra'>{extra}</div>}
        </div>
        {children && <div className='wk-page-header-content'>{children}</div>}
      </div>
    )
  }
}
