...
export default class TimePickerPC extends React.Component<TimePickerProps, TimePickerPCState> {
  ...
  render() {
    const { focus, width, height, offsetLeft, offsetTop, activeItem, datas, value, valueString, browseValue, open, isMouseEntry } = this.state;
    const { placeholder, format, size, disabled, bordered, className, allowClear, showNow, showSuffixIcon, showFooter, isColChoose } = this.props;
      ...
      <>
        ...
        >
          <div className="wk-timepicker-input">
            {
              ...
              <span 
                className="wk-timepicker-placeholder"
              >
                {placeholder}
              </span>
            }
            {
              ...
              <span className="wk-timepicker-value">
                {browseValue || valueString}
              </span>
            }
            <input 
          ...
          <span className="wk-timepicker-suffix" onClick={this.handleClear} >
            ...
            {
              !allowClear && showSuffixIcon &&
              <i className="iconfont wk-icon-time"/>
            }
            {
