...
const UploadPage: React.FC = () => {
  ...
  const handleChange = (info) => {
    ...
    if (info.file.status === 'done') {
      ...
      getBase64(info.file.originFileObj, (imageUrl) => {
        setLoading(false), setImageUrl(imageUrl)
      })
    }
  }
  ...
  const uploadButton = (
    <div>
      {loading ? (
        <i className='iconfont wk-icon-loading-solid-round' />
      ) : (
    ...
    <div style={{ paddingBottom: '20px' }}>
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            ...
            dangerouslySetInnerHTML={{ __html: UploadBaseMd.html }}
          />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            className='gird-descrition'
            dangerouslySetInnerHTML={{ __html: UploadPictureCardMd.html }}
          />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            className='gird-descrition'
            dangerouslySetInnerHTML={{ __html: UploadDefaultListMd.html }}
          />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            className='gird-descrition'
            dangerouslySetInnerHTML={{ __html: UploadPictureWardMd.html }}
          />
        }
      />
