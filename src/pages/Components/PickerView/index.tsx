...
const PickerViewPage: React.FC = () => {
  ...
  return (
    <div style={{paddingBottom: '20px'}}>
      <PageTitle title='PickerView 选择器' description='PickerView 的功能类似于 Picker ，但它是直接渲染在区域中，而不是弹出窗口。' />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: PickerViewBaseMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        title="API"
        table={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: PickerViewReadMd.html }} />
        }
      />
    </div>
  )
