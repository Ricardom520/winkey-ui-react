...
import { Form, Input, Checkbox, Button, Select, Radio, DatePicker, Switch, TimePicker } from '@/components';
...
const FormPage: React.FC = () => {
  ...
  return (
    <div style={{paddingBottom: '20px'}}>
      <PageTitle title="Form表单" description="高性能表单控件，自带数据域管理。包含数据录入、校验以及对应样式。" />
      ...
      <IntroduceBox
        title="API"
        table={
          <div className="show-html" dangerouslySetInnerHTML={{ __html: FormReadMd.html }} />
        }
      />
    </div>
  )
