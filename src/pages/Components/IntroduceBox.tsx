      ...
      }
      {
        ...
        <div className='container'>
          <div style={{padding: '20px 20px 0 20px'}}>
            ...
            <div className='code' style={{height: openFlag ? `${height}px` : 0, overflow: 'hidden', marginBottom: openFlag ? '20px' : 0}}>
              {markdown}
            </div>
          </div>
          {
            ...
            >
              <p>
                ...
                {
                  hoverFlag && <span className='showlineTitle'>{openFlag ? '隐藏代码' : '展示代码'}</span>
                }
              </p>
            </div>
          }
