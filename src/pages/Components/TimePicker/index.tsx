...
const TimePickerPage: React.FC = () => {
  ...
  return (
    <div style={{paddingBottom: '20px'}}>
      <PageTitle title="TimePicker时间选择框" description="当用户需要输入一个时间，可以点击标准输入框，弹出时间面板进行选择。" />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerBaseMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerValueMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerSizeMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerFormatMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerHourMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        demo={
          <div style={{marginBottom: '20px'}}>
            <TimePicker onChange={onChange} defaultValue={moment('02:00:00', 'HH:mm:ss')} showFooter={false} isColChoose />
          </div>
        }
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerHourMd.html }} />
      ...
      <IntroduceBox
        ...
        title="API"
        table={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: TimePickerReadMd.html }} />
        }
      />
    </div>
  )
