  ...
  return (
    <div style={{paddingBottom: '20px'}}>
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: SkeletonBaseMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: SkeletonParagraphMd.html }} />
        }
      />
