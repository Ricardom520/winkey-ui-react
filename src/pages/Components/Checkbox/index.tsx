...
const CheckboxPage: React.FC = () => {
  ...
  const label = `${checked1 ? 'Checked' : 'Unchecked'}-${disabled1 ? 'Disabled' : 'Enabled'}`
  console.log(value)
  return (
    <div style={{ paddingBottom: '20px' }}>
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            className='show-html'
            dangerouslySetInnerHTML={{ __html: CheckboxDisabledMd.html }}
          />
        }
      />
        ...
        demo={
          <div style={{ marginBottom: '20px' }}>
            <p style={{ marginBottom: '20px' }}>
              <Checkbox checked={checked1} disabled={disabled1} onChange={onChange1}>
                {label}
              </Checkbox>
            </p>
            <p>
      ...
      <IntroduceBox
        ...
        demo={
          <div style={{ marginBottom: '20px' }}>
            <Checkbox.Group direction='row' onChange={onChange3} defaultValue={['A']}>
        ...
        markdown={
          <div
            className='show-html'
            dangerouslySetInnerHTML={{ __html: CheckboxDirectionMd.html }}
          />
        }
      />
