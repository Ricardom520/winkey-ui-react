...
const SpinPage: React.FC = () => {
  ...
  return (
    <div style={{ paddingBottom: '20px' }}>
      <PageTitle title='Spin加载中' description='用于页面和区块的加载中状态。' />
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            ...
            dangerouslySetInnerHTML={{ __html: SpinContainerMd.html }}
          />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div
            className='gird-descrition'
            dangerouslySetInnerHTML={{ __html: SpinChildrenMd.html }}
          />
        }
      />
