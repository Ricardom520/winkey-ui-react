  ...
  return (
    <div className='listContainer'>
      ...
      <IntroduceBox
        ...
        demo={
          <div>
            <List dataSource={data} renderItem={(item) => <List.Item required>{item}</List.Item>} />
          </div>
        }
        markdown={
          <div
            className='show-html'
            dangerouslySetInnerHTML={{ __html: ListItemRequiredMd.html }}
          />
        }
      />
      ...
      <IntroduceBox
        title='API'
        table={<div className='show-html' dangerouslySetInnerHTML={{ __html: ListReadMd.html }} />}
      />
    </div>
  )
}
