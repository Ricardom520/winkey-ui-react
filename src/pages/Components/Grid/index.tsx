...
const GridPage: React.SFC = () => {
  ...
  return (
    <div className="gridContainer">
      ...
      <IntroduceBox title="设计理念" 
        table={
          <div className="gird-demo">
            <Row className="demo-row">
              <Col className="demo-col demo-col-1" span={24}>100%</Col>
            </Row>
            <Row className="demo-row">
              <Col className="demo-col demo-col-2" span={6}>25%</Col>
              <Col className="demo-col demo-col-3" span={6}>25%</Col>
              <Col className="demo-col demo-col-2" span={6}>25%</Col>
              <Col className="demo-col demo-col-3" span={6}>25%</Col>
            </Row>
            <Row className="demo-row">
              <Col className="demo-col demo-col-2" span={8}>33.33%</Col>
              <Col className="demo-col demo-col-3" span={8}>33.33%</Col>
              <Col className="demo-col demo-col-2" span={8}>33.33%</Col>
            </Row>
            <Row className="demo-row">
              <Col className="demo-col demo-col-2" span={12}>50%</Col>
              <Col className="demo-col demo-col-3" span={12}>50%</Col>
            </Row>
            <Row className="demo-row">
              <Col className="demo-col demo-col-2" span={16}>66.66%</Col>
              <Col className="demo-col demo-col-3" span={8}>33.33%</Col>
            </Row>
          </div>
        }
      ...
      <IntroduceBox title="概述"
        table={<div className="gird-descrition" dangerouslySetInnerHTML={{ __html: GirdDescMd.html }} />}
      />
      ...
      <IntroduceBox 
        ...
        demo={
          <div className="gird-demo2">
            <Row>
              <Col span={24} className="demo-col demo-col-1">col</Col>
            </Row>
            <Row>
              <Col span={12} className="demo-col demo-col-1">col-12</Col>
              <Col span={12} className="demo-col demo-col-2">col-12</Col>
            </Row>
            <Row>
              <Col span={8} className="demo-col demo-col-1">col-8</Col>
              <Col span={8} className="demo-col demo-col-2">col-8</Col>
              <Col span={8} className="demo-col demo-col-1">col-8</Col>
            </Row>
            <Row>
              <Col span={6} className="demo-col demo-col-1">col-6</Col>
              <Col span={6} className="demo-col demo-col-2">col-6</Col>
              <Col span={6} className="demo-col demo-col-1">col-6</Col>
              <Col span={6} className="demo-col demo-col-2">col-6</Col>
            </Row>
          </div>
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: GirdGutterMd.html }} />
        }
      />
      ...
      <IntroduceBox
        ...
        markdown={
          <div className="gird-descrition" dangerouslySetInnerHTML={{ __html: GirdOffsetMd.html }} />
        }
      />
